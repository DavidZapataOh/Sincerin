...
// Source: github.com/sincerin/l1/tests/warp/aggregator (interfaces: SignatureGetter)
//
// Generated by this command:
//
//	mockgen -package=aggregator -destination=mock_signature_getter.go . SignatureGetter
//
